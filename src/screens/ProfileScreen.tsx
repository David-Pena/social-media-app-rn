  ...
  return (
    <View style={styles.container}>
      ...
      {isMe && (
        <>
          <View style={styles.buttonsContainer}>
            ...
            <Pressable onPress={signOut} style={[styles.button, { flex: 0, width: 50 }]}>
      ...
      <View style={styles.textLine}>
        <Entypo name="graduation-cap" size={18} color="gray" style={{ width: 25 }} />
      ...
      <View style={styles.textLine}>
        <Entypo name="location-pin" size={18} color="gray" style={{ width: 25 }} />
